        ...
        run: function(controller,globalForm,tableForm){
            $( ".ui-sortable" ).sortable({
                ...
                update: function(){
                    ...
                    $.jmRequest({
                        handler: "ajax",
                        url: controller+'&action=edit&edit='+$('input[name="edit"]').val()+'&plugin=attachfile&mod=order',
                        method: 'POST',
                        data : serial,
                        success:function(e){
                            $.jmRequest.initbox(e,{
            ...
            if($('#plugins-attachfile').hasClass('active')) {
                $('.progress').hide();
